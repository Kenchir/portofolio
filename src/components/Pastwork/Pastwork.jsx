                ...
                <br></br><br></br>
                    ...
                    <div id="myTab2Content" class="tab-content">
                        <div id="home2" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade py-5 show active">
                           ...
                           < p className="text-center">Check out  projects on my github account:
                            <br></br>
                            <a href="https://github.com/Kenchir" target="_blank" rel="noopener noreferrer" className="text-dark text-center mx-auto"><i class="fab fa-github-square fa-4x p-2 text-center"></i></a>
                            </p>
                        </div> 
